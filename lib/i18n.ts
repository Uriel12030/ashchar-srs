...
const en: Dict = {
  ...
  operationalScale: {
    ...
    metrics: [
      ...
      { value: "3000+", label: "Security personnel", note: "Provided with lodging service" },
      { value: "20", label: "Staff", note: "Immediately available" },
      { value: "$40M+", label: "Annual procurement", note: "Volume across services" },
    ],
  },
  valueStrip: [
  ...
  about: {
    ...
    scaleItems: [
      ...
      { value: "3000+", text: "Security personnel provided with lodging" },
      { value: "20", text: "Staff immediately available" },
      { value: "$40M+", text: "Annual procurement volume" },
    ],
...
const he: Dict = {
  ...
  operationalScale: {
    ...
    metrics: [
      ...
      { value: "3000+", label: "אנשי ביטחון", note: "קיבלו שירותי לינה" },
      { value: "20", label: "אנשי צוות", note: "בזמינות מיידית" },
      { value: "$40M+", label: "רכש שנתי", note: "היקף שנתי כולל" },
    ],
  },
  valueStrip: [
  ...
  about: {
    ...
    scaleItems: [
      ...
      { value: "3000+", text: "אנשי ביטחון שקיבלו שירותי לינה" },
      { value: "20", text: "אנשי צוות בזמינות מיידית" },
      { value: "$40M+", text: "היקף רכש שנתי" },
    ],
