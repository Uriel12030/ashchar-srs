...
export const metadata: Metadata = {
  title: "Capabilities",
  description:
    "Modular facilities, bunkers, heavy equipment, fleets, site development, power, logistics, emergency response.",
};
  ...
  return (
    <>
      <CinematicHero
        ...
        headline={`Equipment.\nFacilities.\nExecution.`}
        sub="A complete operational toolkit. Owned, maintained, and ready to deploy across Israel."
                ...
                <div className="mx-auto max-w-container px-6 py-24 md:px-10 md:py-40">
                  ...
                  >
                    ...
                    >
                      ...
                      <h2 className="mt-6 font-display text-4xl font-light leading-[1.05] tracking-ultratight text-bone md:text-display-md">
                        {c.title}
                      </h2>
